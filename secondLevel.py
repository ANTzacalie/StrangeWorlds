...
def Game():
    ...
    scene2_objects = [pygame.Rect(0,864,96*4,92*3),pygame.Rect(96,768,96*2,96),pygame.Rect(480,672,96*4,96),pygame.Rect(1056,672,96*2,96),pygame.Rect(1824,768,96,96*3)]
    ...
    while True:
        ...
        if player.playerRect.right >= width and scenes_counter != 9:
            ...
            import thirdLevel; thirdLevel.Game()
        ...
        for k in range(0 , len(scenes_traps[scenes_counter])):
            if player.playerRect.colliderect(scenes_traps[scenes_counter][k]):
                player.playerRect.x = scenes_vector[scenes_counter][0].x; player.playerRect.bottom = scenes_vector[scenes_counter][0].top
